...
//Problem Statement : To find if Birthday paradox is really valid.

----------------------------PROGRAM------------------------------------
/**
 *  Select random people to find
 *  a duplicate birthday (like two peole who were born on the
 *  same day of the same month, but not necessarily in the same
 *  year).  This program simulates the process.  (29th Feb Ignored.)
 */
